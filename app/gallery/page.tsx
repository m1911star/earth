...
export default function Gallery() {
  ...
  return (
    <>
      ...
      <div className="absolute top-4 left-4 flex flex-col gap-2 text-sm text-black-500 w-[300px] overflow-y-auto bg-transparent backdrop-blur-md border-2 border-white rounded-md p-4">
